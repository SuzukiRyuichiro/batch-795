...
describe '#french_ssn_info' do
  ...
  it "If ssn is invalid because the trailing number doesn't meet the requirement, it should return 'The number is invalid'" do
    actual = french_ssn_info('2 86 04 72 123 456 38')
    expect(actual).to eq('The number is invalid.')
  end
end
